...
describe('smokeTest: kroki', () => {
  test('T1: wszystko OK → 7 kroków zielonych, raport z wersją i szczegółami', () => {
    ...
    assert.equal(s['Triggery'].detail, 'import GSC: TAK | import GA4: TAK | strażnik alertów: TAK | adresy z sitemap: NIE | inspekcja URL: NIE | live check SEO: NIE | kolejka recrawl: NIE | pomiar wydajności: NIE');
