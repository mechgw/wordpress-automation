...
describe('Status.gs cells, menu and dialog', () => {
  ...
  test('onOpen adds the Dane menu with both items', () => {
    ...
    assert.deepEqual(dane.items.map(i => i.fn), ['showImportStatus', 'refreshImportStatusCells', 'sprawdzAktualnoscImportowZMenu', 'ustawCodzienneAlerty', 'diagnostykaSystemu', 'pokazZajetoscArkusza', 'wyczyscStareSnapshotyIWyniki', 'przytnijPusteWiersze', 'kanonizujZnacznikiPomiaru', 'uporzadkujArkuszeZMenu', 'ukryjArkuszeTechniczne', 'pokazArkuszeTechniczne']);
