...
**Każda treść issue i każdy komentarz są podpisane** ostatnią linijką: `_— agent lokalny (Claude Code)_` albo `_— recenzent zewnętrzny (GPT)_`. Bez tego nie da się później odróżnić własnego, niezweryfikowanego twierdzenia od audytu drugiej strony, bo wszystko idzie z jednego konta. Konwencja obowiązuje od 2026-09-08; wpisy bez podpisu po tej dacie pochodzą od właściciela.
