...
**Podpisujemy każdą treść issue i każdy komentarz** — ostatnią linijką: `_— agent lokalny (Claude Code)_` albo `_— recenzent zewnętrzny (GPT)_`. Bez tego nie da się później odróżnić własnego, niezweryfikowanego twierdzenia od audytu drugiej strony, bo wszystko idzie z jednego konta. Konwencja obowiązuje od **2026-09-09T00:00:00Z** — wpisy sprzed tej chwili są niepodpisane i ich autorstwa nie da się ustalić, bo 8 września powstało kilkadziesiąt komentarzy obu stron. Dopiero brak podpisu po tej chwili znaczy „napisał właściciel”. Niezależnie od podpisu prefiks `/audit-ok` i `/audit-changes` wskazuje werdykt recenzenta zewnętrznego.
