...
function sheetCatalog_() {
  ...
  return [
    ...
    { name: SEO_SCHEMA_SHEET, category: 'konfiguracja', owner: 'człowiek', description: 'Reguły JSON-LD per adres, czytane przez „SEO LIVE”. Bez tej zakładki kontrola schema po prostu się nie wykonuje.' },
    { name: PERF_URLS_SHEET, category: 'konfiguracja', owner: 'człowiek', description: 'Lista adresów do pomiaru wydajności. Skrypt wyłącznie z niej czyta — to jedyne miejsce, które decyduje, co jest mierzone.' },
